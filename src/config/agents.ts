...
export const agents: Agent[] = [
  ...
  {
    id: 'cultivation',
    elevenLabsAgentId: process.env.NEXT_PUBLIC_ELEVEN_LABS_CULTIVATION_AGENT || 'agent_6001keqst9dpepyb2mfycf5pfewz',
  ...
  {
    id: 'ai-strategy',
    elevenLabsAgentId: process.env.NEXT_PUBLIC_ELEVEN_LABS_AI_STRATEGY_AGENT || 'agent_4801keqstp34ervrd4wwjdyat8kf',
  ...
  {
    id: 'extraction',
    elevenLabsAgentId: process.env.NEXT_PUBLIC_ELEVEN_LABS_EXTRACTION_AGENT || 'agent_5901keqsv5fgehtbjqqyxdcft57p',
  ...
  // Tier 2: Specialist Upsells
  {
    ...
    elevenLabsAgentId: process.env.NEXT_PUBLIC_ELEVEN_LABS_MYCOLOGY_AGENT || 'agent_9801keqsvsv1eags8xf1knvbh3n1',
  ...
  },
  {
    ...
    elevenLabsAgentId: process.env.NEXT_PUBLIC_ELEVEN_LABS_COMP_CHEM_AGENT || 'agent_8601keqsw2wve66s6035207rkrzv',
  ...
  {
    id: 'drug-discovery',
    elevenLabsAgentId: process.env.NEXT_PUBLIC_ELEVEN_LABS_DRUG_DISCOVERY_AGENT || 'agent_0701keqswgnyfk09dqjttd8z6dcr',
